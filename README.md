...
* 🔗 **Peblo – AI Quiz Engine**
  → Upload PDF → Generate questions using LLM
  https://github.com/20omkale/peblo-quiz-engine

* 🌱 **Carbon MRV System (Blockchain)** *(in progress)*
  → Monitoring, Reporting & Verification of carbon data

* ✈️ **Smart Airport Ride Pooling Backend**
  → Backend system for ride optimization
  https://github.com/20omkale/smart-airport-ride-pooling-backend

* 🏗️ **Construction API**
  → Backend APIs for real-world workflows
  https://github.com/20omkale/construction-api

* 🤖 **PocketFM Romantasy Scraper**
  → Automation + data extraction system
...
> No backup plan. Just building, learning, and improving every day.
